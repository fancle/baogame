...
var Map = function (game, data) {
    ...
    this.hooks = (data && data.hooks) || {};
    
    this.structs = [];
    if(data && data.structs){
	for(let struct of data.structs) {
	    var s = new structs[struct.type](this.game,this, struct);
	    this.structs.push(s);
	}
	...
	this.structs.push(new structs.itemGate(this.game, this, {id: 1, x: 0, y: this.h/2}));
	this.structs.push(new structs.itemGate(this.game, this, {id: 2, x: this.w - 1, y: this.h/2}));
	this.structs.push(new structs.itemGate(this.game, this, {id: 3, x: this.w/2, y: this.h - 1}));
    }
